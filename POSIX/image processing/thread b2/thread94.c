...
/******************************************************************************
  ...
  To compile adapt the code below wo match your filenames:  
    cc -o thread94 thread94.c -lglut -lGL -lm 
...
void detect_edges(unsigned char *in, unsigned char *out,B_thread *args) {
  int i;
